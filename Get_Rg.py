...
output_file = '2700bp_bm.xlsx'         # Name of the Excel Workbook to store the data in
...
par_back_1 = 0.01      # Height value for the first background threshold - should be chosen once and kept the same
par_back_2 = 0.02        # Height value for the second background threshold - should be chosen once and kept the same
par_min_area = 300          # Minimum amount of pixels for a molecule to be considered for analysis
par_dna_bp = 2700            # Length of the bare DNA in bp (used to help categorizing molecules as too short and too long)
