...
deconvolve = {'decon': True,                # Applies a deconv. for tracing. Only works when bare DNA analysis is True
              'tip_shape': None}
output_file = '1000bp_APS_img3.xlsx'                  # Name of the Excel Workbook to store the data in
...
export_select_manually = False               # Select the data to be exported as valid manually
add_file_name_pars = False                   # Adds image specs to the excel sheet - proper naming necessary (GUIDE)
